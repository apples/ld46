...
#endif
    {
        ...
        for (int y = 0; y < h; ++y) {
            ...
            for (int x = 0; x < w; ++x) {
                ...
                double negDist = -SignedDistance::REALLYBIG.distance;
                double posDist = SignedDistance::REALLYBIG.distance;
                int winding = 0;
                ...
                double sd = SignedDistance::REALLYBIG.distance;
...
#endif
    {
        ...
        for (int y = 0; y < h; ++y) {
            ...
            for (int x = 0; x < w; ++x) {
                ...
                double psd = SignedDistance::REALLYBIG.distance;
                if (posDist >= 0 && fabs(posDist) <= fabs(negDist)) {
                    psd = posDist;
                    winding = 1;
                    for (int i = 0; i < contourCount; ++i)
...
#endif
    {
        ...
        for (int y = 0; y < h; ++y) {
            ...
            for (int x = 0; x < w; ++x) {
                ...
                double d = fabs(SignedDistance::REALLYBIG.distance);
                double negDist = -SignedDistance::REALLYBIG.distance;
                double posDist = SignedDistance::REALLYBIG.distance;
                int winding = 0;
                ...
                MultiDistance msd;
                msd.r = msd.g = msd.b = msd.med = SignedDistance::REALLYBIG.distance;
                if (posDist >= 0 && fabs(posDist) <= fabs(negDist)) {
                    msd.med = SignedDistance::REALLYBIG.distance;
                    winding = 1;
                    for (int i = 0; i < contourCount; ++i)
